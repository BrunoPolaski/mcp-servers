#!/usr/bin/env python3
"""Gera os 30 cenarios de avaliacao nas quatro fontes.
...
das quatro fontes, que frequentemente discordam entre si.
  ...
  bom (1-3)        10%  historico alinhado nas quatro fontes, aprovacao direta
  ruim (4-6)       10%  regra eliminatoria evidente, reprovacao direta
  complexo (7-30)  80%  sinais conflitantes, dados faltantes, valores em cima
...
CENARIOS = {
    # ============ bons (1-3): raros, alinhados nas quatro fontes =============
    1: cenario("bom", 842, 9800, 0.16, 0.10, 1.00,
               ...
               interno=(1.00, 0)),
    2: cenario("bom", 831, 4200, 0.20, 0.14, 0.98,
    ...
    3: cenario("bom", 810, None, 0.20, 0.12, 0.97,
    ...
    # =============== ruins (4-6): raros, eliminatoria evidente ===============
    4: cenario("ruim", 512, 4200, 0.39, 0.48, 0.84, "alerta de fraude grave e ativo",
               ...
               interno=(0.78, 40)),
    5: cenario("ruim", 241, 3100, 0.52, 0.77, 0.66, "score critico, abaixo do piso da politica",
               ...
               interno=(0.62, 55)),
    6: cenario("ruim", 680, 4200, 0.30, 0.35, 0.80,
    ...
    # =========== complexos (7-30): a maioria, sinais conflitantes ============
    7: cenario("complexo", 812, 7200, 0.44, 0.62, 0.9,
               "biro otimo e comportamento interno pessimo: fontes discordam",
               mudou=True, vinculo=("Industria XYZ", CLT, "2017-10-01", 7200, True),
               fluxo=(7300, 5500, 0.07, 0, True), banco=(63, "varejo", 15000),
               score_interno=372, interno=(0.58, 22)),
    8: cenario("complexo", 612, 5600, 0.42, 0.58, 0.86,
    ...
    9: cenario("complexo", 596, 3800, 0.43, 0.55, 0.87,
               ...
               interno=(0.87, 0)),
    10: cenario("complexo", 767, 7100, 0.25, 0.21, 0.97,
                ...
                interno=(0.70, 128)),
    11: cenario("complexo", 828, 11200, 0.18, 0.12, 1.00,
    ...
    12: cenario("complexo", 601, 6600, 0.43, 0.57, 0.86, "cliente nunca passou por validacao cadastral",
    ...
    13: cenario("complexo", 596, 5700, 0.44, 0.59, 0.85, "consentimento de open finance revogado",
    ...
    14: cenario("complexo", 648, 6900, 0.37, 0.47, 0.9, "nao-cliente da instituicao, sem historico interno",
    ...
    15: cenario("complexo", 592, 4500, 0.43, 0.58, 0.86, "sem historico de pagamento no biro",
    ...
    16: cenario("complexo", 588, None, 0.44, 0.59, 0.85,
    ...
    17: cenario("complexo", None, 5600, 0.31, 0.33, 0.94, "biro sem score calculado",
    ...
    18: cenario("complexo", 604, 4900, 0.34, 0.4, 0.86,
                ...
                falta=("dti", "utilizacao", "email", "telefone"), interno=(0.91, 0)),
    19: cenario("complexo", 700, 6000, 0.30, 0.30, 0.95, "tres criterios exatamente no limite superior da faixa",
    ...
    20: cenario("complexo", 699, 6000, 0.31, 0.31, 0.949, "os mesmos criterios um passo abaixo do limite",
                consultas=3, vinculo=("Comercio ABC", CLT, "2020-01-01", 6000, True),
                fluxo=(6550, 5400, 0.12, 1, True), banco=(59, "varejo", 8000),
                score_interno=799, interno=(0.949, 0)),
    21: cenario("complexo", 662, 5100, 0.35, 0.39, 0.92, "negativacao ativa e contestada pelo cliente",
                ...
                interno=(0.92, 0)),
    22: cenario("complexo", 788, 8600, 0.46, 0.66, 0.94, "as mesmas dividas, agora acima do teto",
                ...
                interno=(0.94, 0)),
    23: cenario("complexo", 650, 5000, 0.35, 0.40, 0.90, "CPF ausente no cadastro, aciona M3",
    ...
    24: cenario("complexo", 600, 4800, 0.35, 0.38, 0.85,
    ...
    25: cenario("complexo", [(820, "2025-01-10"), (560, "2026-08-01")], 4600, 0.38, 0.45, 0.83,
                ...
                interno=(0.85, 0)),
    26: cenario("complexo", 680, 5300, 0.32, 0.34, 0.90,
                ...
                interno=(0.92, 0)),
    27: cenario("complexo", 590, 5000, 0.35, 0.40, 0.87,
    ...
    28: cenario("complexo", 760, 6000, 0.25, 0.20, 0.95,
                ...
                interno=(0.95, 0)),
    29: cenario("complexo", 560, None, 0.28, 0.55, 0.72,
    ...
    30: cenario("complexo", 660, 4500, 0.55, 0.40, 0.92,
