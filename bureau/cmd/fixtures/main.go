...
import (
	...
	"github.com/BrunoPolaski/bureau/internal/infra/thirdparty/database"
...
var loadOrder = []fixtureTarget{
	...
	{FileName: "credit_scores.json", TableName: "credit_scores"},
	{FileName: "financial_profiles.json", TableName: "financial_profiles"},
	{FileName: "persons.json", TableName: "persons"},
	{FileName: "data_sources.json", TableName: "data_sources"},
	{FileName: "person_data_sources.json", TableName: "person_data_sources"},
	{FileName: "person_addresses.json", TableName: "person_addresses"},
	{FileName: "person_documents.json", TableName: "person_documents"},
	{FileName: "employment_records.json", TableName: "employment_records"},
	{FileName: "credit_accounts.json", TableName: "credit_accounts"},
	{FileName: "debts.json", TableName: "debts"},
	{FileName: "payment_histories.json", TableName: "payment_histories"},
	{FileName: "credit_inquiries.json", TableName: "credit_inquiries"},
	{FileName: "legal_records.json", TableName: "legal_records"},
	{FileName: "fraud_alerts.json", TableName: "fraud_alerts"},
	{FileName: "negative_records.json", TableName: "negative_records"},
	{FileName: "risk_assessments.json", TableName: "risk_assessments"},
	{FileName: "person_relationships.json", TableName: "person_relationships"},
...
func main() {
	...
	if _, err := os.Stat("/.dockerenv"); err == nil {
		...
		if os.Getenv("ENV") == "production" {
			...
			os.Setenv("DATABASE_URL", "postgres://root:123456@127.0.0.1:5433/bureau?sslmode=disable")
		}
	}
